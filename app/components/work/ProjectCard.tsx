      ...
      >
            ...
            <>
              ...
              {server && (
                <Link
                  ...
                  href={server}
                  target="_blank"
                  aria-label="Open GitHub Server Repository"
                  className="w-[43px] rounded-full bg-white p-3 text-[20px] md:w-[65px] md:p-5 md:text-[24px] lg:w-[65px] lg:text-[28px]"
                  data-blobity
                  data-blobity-radius="35"
                  data-blobity-offset-x="4"
        ...
        >
          <AnimatedTitle
            text={name}
            className={
              "max-w-[90%] text-[20px] leading-none text-white md:text-[28px] md:leading-none  lg:max-w-[450px] lg:text-[30px] lg:leading-none"
            }
            wordSpace={"mr-[0.25em]"}
            charSpace={"-mr-[0.01em]"}
          />
